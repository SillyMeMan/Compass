...
import net.vinh.compass.helpers.RenderHelper;
...
public class RenderHandler {
	...
	public static void renderLast(MatrixStack stack) {
		...
		if (ClientConfig.DELAYED_RENDERING) {
			...
			DELAYED_RENDER.draw(CompassRenderLayers.TRANSPARENT_PARTICLE);
			DELAYED_RENDER.draw(CompassRenderLayers.ADDITIVE_PARTICLE);
