package net.vinh.compass.handlers;
...
import net.vinh.compass.systems.rendering.particle.screen.GenericScreenParticle;
...
import net.vinh.compass.systems.rendering.particle.screen.emitter.ItemParticleEmitter;
import net.vinh.compass.systems.rendering.particle.screen.emitter.ParticleEmitter;
...
import static net.vinh.compass.systems.rendering.particle.screen.base.ScreenParticle.RenderOrder.*;
...
public class ScreenParticleHandler {
	...
	public static void renderParticles(ScreenParticle.RenderOrder... renderOrders) {
		...
		try {
			...
			CompassLib.LOGGER.info("What is this\n" + e.getMessage());
		}
	}
