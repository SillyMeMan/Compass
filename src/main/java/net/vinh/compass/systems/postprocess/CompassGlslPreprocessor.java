package net.vinh.compass.systems.postprocess;
...
public class CompassGlslPreprocessor extends GlslImportProcessor {
	@Nullable
	@Override
	public String loadImport(boolean inline, String name) {
		CompassLib.LOGGER.debug("Loading moj_import in EffectProgram: " + name);
		...
		try {
			...
			CompassLib.LOGGER.error("Could not open GLSL import {}: {}", name, ioexception.getMessage());
