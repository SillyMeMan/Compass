package net.vinh.compass.systems.rendering.particle.world;
...
import net.vinh.compass.systems.rendering.particle.ParticleTextureSheets;
import net.vinh.compass.systems.rendering.particle.SimpleParticleEffect;
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
		...
		if (ClientConfig.DELAYED_RENDERING) {
			if (getType().equals(ParticleTextureSheets.ADDITIVE)) {
				consumer = RenderHandler.DELAYED_RENDER.getBuffer(CompassRenderLayers.ADDITIVE_PARTICLE);
			}
			if (getType().equals(ParticleTextureSheets.TRANSPARENT)) {
				consumer = RenderHandler.DELAYED_RENDER.getBuffer(CompassRenderLayers.TRANSPARENT_PARTICLE);
			}
		}
