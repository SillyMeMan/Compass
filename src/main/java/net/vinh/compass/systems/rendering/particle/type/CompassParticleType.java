package net.vinh.compass.systems.rendering.particle.type;

import com.mojang.serialization.Codec;
import net.vinh.compass.systems.rendering.particle.world.GenericParticle;
import net.vinh.compass.systems.rendering.particle.world.WorldParticleEffect;
...
public class CompassParticleType extends ParticleType<WorldParticleEffect> {
	public CompassParticleType() {
