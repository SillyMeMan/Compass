package net.vinh.compass.network.screenshake;

import net.vinh.compass.CompassLib;
import net.vinh.compass.handlers.ScreenshakeHandler;
import net.vinh.compass.systems.rendering.particle.Easing;
import net.vinh.compass.systems.screenshake.PositionedScreenshakeInstance;
...
public class PositionedScreenshakePacket extends ScreenshakePacket {
	...
	public static final Identifier ID = new Identifier(CompassLib.MODID, "positionedscreenshake");
